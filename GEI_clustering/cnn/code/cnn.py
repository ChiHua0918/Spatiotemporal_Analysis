...
def writeCSV(result,folder,cutType,source,year):
    outputFile = f"./cnn/data/{year}/{folder}/{cutType}/{source}.csv"
...
def main(source,outputFolder,cutType,year):
    # model
    ...
    writeCSV(GEI_dot,outputFolder,cutType,source,year)
